...
namespace SnapWheel
{
    ...
    {
#if NO_KEY
        public const string Version = "0.2.4";   // 变体：多 Wheel + 框选缩放/锁定（无万能键）
#else
        public const string Version = "0.3.4";   // 完整版：含万能键摇杆 + 旋转 + 缩放修正
#endif
        ...
        void DrawWheel(Graphics g, int w, int h)
        {
            ...
            using (GraphicsPath gp = new GraphicsPath())
            {
                ...
                if (_dropActive)
                {
                    ...
                    using (Pen dm = new Pen(Color.FromArgb((int)(235 * a / 255f), dc.R + 24, dc.G + 24, dc.B + 24), 6f))
