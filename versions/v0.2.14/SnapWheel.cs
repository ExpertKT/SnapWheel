...
namespace SnapWheel
{
    ...
    {
#if NO_KEY
        public const string Version = "0.2.14";   // 变体：多 Wheel + 框选缩放/锁定（无万能键）
#else
        public const string Version = "0.4.4";   // 完整版：含万能键摇杆 + 旋转 + 缩放修正
#endif
    ...
    class WheelForm : Form
    {
        ...
        void BackdropClip(Graphics g, GraphicsPath path)
        {
            ...
            try
            {
                ...
                int dk = (int)(34 * (StyleSolid() ? 1f : _settings.GlassPercent / 100f));
