...
绿色免安装 · 单文件 C# / WinForms · **零第三方依赖** · 一个 354 KB 的 exe，Windows 10 / 11 双击就跑。
...
![version](https://img.shields.io/badge/version-v0.9.10-blue?style=flat-square)
![status](https://img.shields.io/badge/status-BETA-orange?style=flat-square)
![size](https://img.shields.io/badge/exe-354%20KB-lightgrey?style=flat-square)
...
**纯 C# / WinForms 实现（src\ 下按类型分文件），绿色免安装，零第三方依赖** —— 一个 354 KB 的 exe，拷到任何 Windows 10/11 上双击就能跑。
