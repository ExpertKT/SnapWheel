...
绿色免安装 · 单文件 C# / WinForms · **零第三方依赖** · 一个 350 KB 的 exe，Windows 10 / 11 双击就跑。
...
![size](https://img.shields.io/badge/exe-350%20KB-lightgrey?style=flat-square)
...
**纯 C# / WinForms 实现（src\ 下按类型分文件），绿色免安装，零第三方依赖** —— 一个 350 KB 的 exe，拷到任何 Windows 10/11 上双击就能跑。
